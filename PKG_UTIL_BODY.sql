CREATE OR REPLACE PACKAGE BODY PKG_UTIL IS
  ...
  FUNCTION foneticabr(str1 IN VARCHAR2) RETURN VARCHAR2 IS   
    chars_s VARCHAR2(255) := 'BL,BR,Ç,CHR,CA,CE,CH,CI,CK,CO,CS,CT,CU,C,GE,GI,GL,GM,GR,LH,LT,L,MD,MG,MJ,NG,NH,NJ,N,PH,PR,Q,RG,RJ,RM,RS,RT,ST,TL,TR,TS,W,X,Y,Z';
    chars_r VARCHAR2(255) := 'B,B,S,KR,K,S,S,S,K,K,S,T,K,K,J,J,G,M,G,L,T,R,M,G,J,G,N,J,M,F,P,K,G,J,SM,S,T,T,T,T,S,U,S,I,S';
    str     VARCHAR2(3000);
